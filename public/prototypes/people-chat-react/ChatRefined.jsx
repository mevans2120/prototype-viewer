...
function FAB() {
  return (
    <div style={{
      position: 'absolute', bottom: 97, left: '50%',
    ...
    <div style={{ position: 'absolute', inset: 0, background: '#fff' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end', gap: 6, marginBottom: 10 }}>
          <div style={{
            width: 26, height: 26, borderRadius: 13, background: _P_BLUE, color: '#fff',
            fontSize: 10, fontWeight: 800, display: 'flex', alignItems: 'center', justifyContent: 'center',
            flexShrink: 0, marginBottom: 18,
          }}>RO</div>
          <div style={{
            background: '#fff', border: `1px solid ${_LINE}`, borderRadius: 16,
            padding: 8, maxWidth: 240, boxShadow: '0 1px 2px rgba(0,0,0,0.04)',
          }}>
            <div style={{
              height: 110, width: 220, background: _MAP_BG, borderRadius: 10, position: 'relative',
              overflow: 'hidden',
            }}>
              <div style={{
                ...
                <IconPin size={30} stroke={2} fill={_P_BLUE_LIGHT} />
              </div>
            </div>
            <div style={{ fontSize: 13, fontWeight: 700, color: _INK, marginTop: 8, padding: '0 4px' }}>
              5344 SE Knapp St
            </div>
            <div style={{ fontSize: 11, color: _INK_3, padding: '0 4px 2px' }}>Rachel's location · now</div>
          </div>
        </div>
      </div>
      <div style={{
    ...
    <window.DesignCanvas minScale={0.15} maxScale={2.5}>
      ...
      <div style={{ padding: '0 60px 48px', maxWidth: 980 }}>
        ...
        <div style={{ fontSize: 16, color: '#555', lineHeight: 1.55, maxWidth: 760, marginTop: 14 }}>
          A Chat tab joins Map and History. Open Chat, pick someone, send a message — including a simple location share when you need to say where you are.
        </div>
      </div>
